...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL menuAllowSubmenus SWIFT_DEPRECATED_MSG("Use `menuPushStyle = .subMenu` instead.", "menuPushStyle");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL menuAllowPopIfPossible SWIFT_DEPRECATED_MSG("Use `menuPushStyle = .popWhenPossible` instead.", "menuPushStyle");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL menuReplaceOnPush SWIFT_DEPRECATED_MSG("Use `menuPushStyle = .replace` instead.", "menuPushStyle");)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) CGFloat menuAnimationShrinkStrength SWIFT_DEPRECATED_MSG("", "menuAnimationTransformScaleFactor");)
